...
interface IFuseERC20 {
    event mintFUSE(address indexed _from, address indexed mintedby);
    function mintByContract(uint256 _amt) external returns(bool);
...
contract FuseCoreV2{
    ...
    //IFuseERC20 Rinkeby : 0xE4498B7E7573Bd9FF9452C878e3049e95Fa422E6
    event HTLCERC721New(
    ...
    function depositWeth(uint256 _wethSupply)
    ...
    function mintERC20(uint256 _supply) external returns(bool){
        
      
        return IFuseERC20(0xA58d93A2a4feD0bddFfABabe87f1eba2e0e12Fc6).mintByContract(_supply);
    }
